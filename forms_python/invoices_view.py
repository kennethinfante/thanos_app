...
class Ui_invoicesView(object):
    def setupUi(self, invoicesView):
        ...
        self.invoice_num_label.setMinimumSize(QtCore.QSize(130, 50))
        self.invoice_num_label.setMaximumSize(QtCore.QSize(130, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.search_hbox.addWidget(self.invoice_num_label)
        ...
        self.invoice_num_line_edit.setMinimumSize(QtCore.QSize(200, 50))
        self.invoice_num_line_edit.setMaximumSize(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.invoice_num_line_edit.setFont(font)
        self.invoice_num_line_edit.setObjectName("invoice_num_line_edit")
        self.search_hbox.addWidget(self.invoice_num_line_edit)
    ...
    def retranslateUi(self, invoicesView):
        ...
        self.invoice_num_label.setText(_translate("invoicesView", "Invoice #"))
