...
class Ui_invoicesWidget(object):
    def setupUi(self, invoicesWidget):
        ...
        self.invoice_no_label = QtWidgets.QLabel(self.centralwidget)
        self.invoice_no_label.setMinimumSize(QtCore.QSize(160, 50))
        self.invoice_no_label.setMaximumSize(QtCore.QSize(160, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.invoice_no_label.setFont(font)
        self.invoice_no_label.setObjectName("invoice_no_label")
        self.horizontalLayout.addWidget(self.invoice_no_label)
        self.invoice_no_line_edit = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.invoice_no_line_edit.sizePolicy().hasHeightForWidth())
        self.invoice_no_line_edit.setSizePolicy(sizePolicy)
        self.invoice_no_line_edit.setMinimumSize(QtCore.QSize(230, 50))
        self.invoice_no_line_edit.setMaximumSize(QtCore.QSize(16777215, 50))
        self.invoice_no_line_edit.setObjectName("invoice_no_line_edit")
        self.horizontalLayout.addWidget(self.invoice_no_line_edit)
